                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" id="quarter">
                                            ...
                                            <select class="form-control quarter select2" style="width: 100%;" name="quarter">
                                                ...
                                                <option value="Quarter_5_2021">Quarter 5 2022</option>
                                                <option value="Quarter_6_2021">Quarter 6 2022</option>
                                            </select>
                                        </div>
                                    </div>
                                    <hr>
                                ...
                                <div class="row">
                                    <div class="col-md-4" id="recieve_ipt">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-danger d-inline">
                                                <input type="radio" id="ipt2" class="ipt_recieve_no" name="recieve_ipt"
                                                    value="no">
                                                <label for="ipt2">
                                                    NO
                                                </label>
