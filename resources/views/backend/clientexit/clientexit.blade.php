...
<section class="content">
    ...
    <div class="card card-warning">
        ...
        <td>{{$kobo->qtr}}</td>
        <td>{{$kobo->today}}</td>
        <td><a href="#" data-toggle="modal" data-target="{{ '#Modal' . $kobo->recordid }}"><i class="fa fa-eye"></i></a>

            <div class="modal fade" id="{{ 'Modal' . $kobo->recordid }}" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
