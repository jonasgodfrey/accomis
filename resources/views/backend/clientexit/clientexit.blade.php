                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="child_name" class="form-control child_name"
                                                placeholder="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" id="res_category">
                                            ...
                                            <select class="form-control res_category" style="width: 100%;" name="res_category">
                                                ...
                                                <option value="Female Pregnant with under 5 child/children">Female Pregnant with
                                                    under 5
                                                    child/children</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 health_facility_of_interview" name=""
                                                style="width: 100%;" id="state_id">
                                                <option style="display: none" value="">Select Health Facility </option>
                                                @foreach ($health_facilities as $health_facility)
                                                    <option id="{{ $health_facility->id }}"
                                                        value="{{ $health_facility->Facility }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" id="occupation">
                                            ...
                                            <select class="form-control select2 occupation" style="width: 100%;"
                                                name="occupation">
                                                ...
                                                <option value="Religious Leader/Missionary">Religious Leader/Missionary
                                                </option>
                                            ...
                                            <div class="other_occupation2">
                                                ...
                                                <input type="text" name="occupation2"
                                                    class="form-control other_occupation field1" placeholder="kindly specify">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" id="education">
                                            ...
                                            <select class="form-control education select2" style="width: 100%;"
                                                ...
                                                <option value="Secondary Education (Uncompleted)">Secondary Education
                                                    (Uncompleted)
                                                </option>
                                            ...
                                            <div class="other_education2">
                                                ...
                                                <input type="text" name=""
                                                    class="form-control educational_bg2 field2" placeholder="kindly specify">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" id="what_did_you_come_for">
                                            ...
                                            <div class="other_reasons2">
                                                <Label>Other</Label>
                                                <input type="text" name=""
                                                    class="form-control what_did_you_come_for2 field3"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group" id="frequency_of_visit">
                                            ...
                                            <select class="form-control frequency_of_visit" name="frequency_of_visit">
                                                <option value="" style="display: none">Select</option>
                                                <option value="Have not been to the facility in the last 3 Months">Have not
                                                    been
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4" id="llin_recieve">
                                        ...
                                        <div class="form-group clearfix" id="recieve_llin">
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="radioPrimary4" class="llin_recieve_yes "
                                                    name="recieve_llin" value="yes">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-danger d-inline">
                                                <input type="radio" id="radiodanger5" class="llin_recieve_no"
                                                    id="llin_recieve_no" name="recieve_llin" value="no">
                                    ...
                                    <div class="col-md-4 llin_true">
                                        <div class="form-group" id="llin_frequency">
                                            ...
                                            <select class="form-control llin_frequency sleep_in_llin_interval"
                                                name="sleep_in_llin_interval">
                                                <option value="" style="display: none">Select</option>
                                    ...
                                    <div class="col-md-4 llin_true">
                                        <div class="form-group" id="llin_frequency">
                                            ...
                                            <select class="form-control llin_frequency reason_for_not_sleeping_in_llin"
                                                name="reason_for_not_sleeping_in_llin">
                                                <option value="" style="display: none">Select</option>
                                                <option value="I don't Know how to hang it">I don't Know how to hang it
                                                </option>
                                ...
                                <div class="row">
                                    <div class="col-md-4" id="recieve_ipt">
                                        ...
                                        <div class="form-group clearfix ">
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="ipt1" class="ipt_recieve_yes"
                                                    name="recieve_ipt" value="yes">
                                                <label for="ipt1">
                                                    YES
                                                </label>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-danger d-inline">
                                                <input type="radio" id="ipt2" class="ipt_recieve_no"
                                                    name="recieve_ipt" value="no">
                                                <label for="ipt2">
                                                    NO
                                                </label>
                                            </div>
                                    ...
                                    <div class="col-md-4 ipt_true">
                                        <div class="form-group" id="ipt_frequency">
                                            ...
                                            <select class="form-control ipt_frequency" name="ipt_frequency">
                                                <option value="" style="display: none">Select</option>
                                                <option value="After 13 Weeks (Quickening)">After 13 Weeks (Quickening)
                                                </option>
                                    ...
                                    <div class="col-md-4" id="smc">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="smc1" class="smc1" value="yes"
                                                    name="smc">
                                                <label for="smc1">
                                                    YES
                                                </label>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-danger d-inline">
                                                <input type="radio" id="smc2" class="smc2" value="no"
                                                    name="smc">
                                                <label for="smc2">
                                                    NO
                                                </label>
                                    ...
                                    <div class="col-md-4" id="malaria_test">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="malaria_test1" class="malaria_test_yes"
                                                    value="yes" name="malaria_test">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-danger d-inline">
                                                <input type="radio" id="malaria_test2" class="malaria_test_no"
                                                    value="no" name="malaria_test">
                                    ...
                                    <div class="col-md-4" id="arthemisinin_based_therapy">
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <p class="arthemisinin_therapy_false">
                                                <input type="text" class="form-control arthemisinin_therapy_false field200"
                                                    name="" placeholder="If No, Specify Drug Received">
                                            </p>
                                        </div>
                                    ...
                                    <div class="col-md-4 arthemisinin_therapy_true" id="arthemisinin_drug_finish">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="arthemisinin_therapy3"
                                                    class="arthemisinin_drug_finish_yes" name="arthemisinin_drug_finish"
                                                    value="yes">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-danger d-inline">
                                                <input type="radio" id="arthemisinin_therapy4"
                                                    class="arthemisinin_drug_finish_no" name="arthemisinin_drug_finish"
                                                    value="no">
                                    ...
                                    <div class="col-md-4 arthemisinin_therapy_show">
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <input type="text" name="arthemisinin_drug_finish_no"
                                                class="form-control arthemisinin_therapy_show_no field9"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group choice_cause">
                                            ...
                                            <p class="other_causes">
                                                <input type="text" name=""
                                                    class="form-control insatisfaction_cause_others2 field10"
                                                    placeholder="Kindly Specify">
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group file">
                                            ...
                                            <input type="file" id="report_file" name="filename"
                                                class="file-input report_file">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Date of Visit</label>
                                            <input type="date" name="date" class="form-control date" placeholder=""
                                                required>
                                ...
                                <div class="col-md-6">
                                    <p></p>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary submit_form" id="submit_form">Submit
                                            Client
                                            Exit</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <form action="" method="get">
                                    <select name="page_views" class="form-control">
                                        ...
                                        <option value="1000"><a
                                                href="{{ url('http://127.0.0.1:8000/clientexit?page_views=1000') }}"
                                                class="">Load 1000 Entries</a></option>
                                        <option value="5000"><a
                                                href="{{ url('http://127.0.0.1:8000/clientexit?page_views=5000') }}"
                                                class="">Load 5000 Entries</a></option>
                                        <option value="10000"><a
                                                href="{{ url('http://127.0.0.1:8000/clientexit?page_views=10000') }}"
                                                class="">Load 10000 Entries</a></option>
                                        <option value="15000"><a
                                                href="{{ url('http://127.0.0.1:8000/clientexit?page_views=15000') }}"
                                                class="">Load 15000 Entries</a></option>
                                        ...
                                        <tr id="sid{{ $client->id }}">
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    @can('admin_me')
                                                        <div class="col-md-6">
                                                            <button class="fa fa-trash btn-sm btn-danger " style="outline: none"
                                                                data-toggle="modal"
                                                                data-target="{{ '#exampleModal' . $client->id }}"></button>
                                            ...
                                            @foreach ($collection as $kobo)
                                                <tr>
                                                    ...
                                                    <td><a href="#" data-toggle="modal"
                                                            data-target="{{ '#Modal' . $kobo->_id }}"><i
                                                                class="fa fa-eye"></i></a>

                                                        <div class="modal fade" id="{{ 'Modal' . $kobo->_id }}"
                                                            tabindex="-1" role="dialog" aria-labelledby="ModalLabel"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="ModalLabel">CEI
                                                                            KoboCollect
                                                                        </h5>
                                                                        ...
                                                                        <div class="card">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <dl class="row">
                                                                                    ...
                                                                                    <dt class="col-sm-4">Did You Receive IPT:
                                                                                    </dt>
                                                                                    <dd class="col-sm-8">
                                                                                        {{ $kobo->ipt_recipient }}
                                                                                    </dd>
                                                                                    <dt class="col-sm-4">Tested fo Malaria?:
                                                                                    </dt>
                                                                                    <dd class="col-sm-8">
                                                                                        {{ $kobo->malaria }}
                                                                                    </dd>
                                                                ...
                                                                <dd class="col-sm-8">
                                                                    {{ $kobo->act_finish}}
                                                                                    ...
                                                                                    <dt class="col-sm-4">Rate the Facility?:
                                                                                    </dt>
                                                                                    <dd class="col-sm-8">
                                                                                        {{ $kobo->rating }}
                                                                                    </dd>
                                                                                    ...
                                                                                    <dt class="col-sm-4">Location (Long/Lat):
                                                                                    </dt>
                                                                                    <dd class="col-sm-8">
                                                                                        {{ $kobo->store_gps }}
                                                                                    </dd>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <a href="{{ '/clientexit/kobo-view/' . $kobo->recordid }}"><i
                                                                    class="fa fa-eye"></i></a>
                                                        </div>
