        ...
        <section class="content">
            <div class="container-fluid">
                <!-- Small boxes (Stat box) -->
                   ...
                   <div class="card-body">
                   <form role="form" action="{{ route('cei_analysis.table') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>CBO</label>
                                    <select name="cbo" class="form-control" style="width: 100%;" id="cbo" disabled required>
